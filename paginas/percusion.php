<?php
    ...
    $productos = $producto -> listarPorCategoria('Percusion', 'categoria', 'noTipo', 'noMarca', 'Mas vendidos');
    $marca = $producto -> listarMarcas('Percusion');
    $tipo = $producto -> listarTipos('Percusion');
    ...
    <div class="container">
        <div class="container_filtros">
            ...
            <ul id="listaCheckBox">
                ...
                <li>
                    ...
                    <input value="<?php echo $fila['tipo'] ?>" class="tipos" type="checkbox" name="tipo" id="<?php echo $fila['tipo']?>" onClick="marcarCheckBoxTipos('<?php echo $fila['tipo']?>', 'Percusion')"><span> <?php echo $fila['tipo'] ?> </span>
            ...
            <ul>
                ...
                <li>
                    ...
                    <input value="<?php echo $fila['marca'] ?>" class="marcas" type="checkbox" name="marca" id="<?php echo $fila['marca']?>" onClick="marcarCheckBoxMarcas('<?php echo $fila['marca']?>', 'Percusion')"><span> <?php echo $fila['marca'] ?> </span>
        ...
        <div class="container_productos">
            <div class="text_seccion">
                <h4>Percusion Menú</h4>
            </div>
            <div class="container_ordenar">
                <span>Ordenar por</span>
                <select name="" id="opcionOrden" onChange="selectFiltro('Percusion')">
