<?php
    ...
    $productos = $producto -> listarPorCategoria('Baterias', 'categoria', 'noTipo', 'noMarca', 'Mas vendidos');
    $marca = $producto -> listarMarcas('Baterias');
    $tipo = $producto -> listarTipos('Baterias');
    ...
    <div class="container">
        <div class="container_filtros">
            ...
            <ul id="listaCheckBox">
                ...
                <li>
                    ...
                    <input value="<?php echo $fila['tipo'] ?>" class="tipos" type="checkbox" name="tipo" id="<?php echo $fila['tipo']?>" onClick="marcarCheckBoxTipos('<?php echo $fila['tipo']?>', 'Baterias')"><span> <?php echo $fila['tipo'] ?> </span>
            ...
            <ul>
                ...
                <li>
                    ...
                    <input value="<?php echo $fila['marca'] ?>" class="marcas" type="checkbox" name="marca" id="<?php echo $fila['marca']?>" onClick="marcarCheckBoxMarcas('<?php echo $fila['marca']?>', 'Baterias')"><span> <?php echo $fila['marca'] ?> </span>
        ...
        <div class="container_productos">
            ...
            <div class="container_ordenar">
                ...
                <select name="" id="opcionOrden" onChange="selectFiltro('Baterias')">
